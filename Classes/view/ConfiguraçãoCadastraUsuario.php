...
<form name="form1" action="../Controller/ControllerCrudUsuario.php" method="post">
    <div align="center">
    <br><br>
    <h2> <b> <u>Alteração de Cadastro</u> </b> </h2>
    <br>
    </div>
    ...
    <div class="container">
            ...
            <div class="form-group col-md-5">
                ...
                <input name="nome" type="text" required class="form-control" id="inputEmail4">
            </div>
            <div class="form-group col-md-5">
                <label for="inputPassword4">Sobrenome</label>
                <input name="sobrenome" required type="text" class="form-control" id="inputPassword4">
            </div>
         <div class="form-group col-md-5">
             <label for="inputPassword4">Telefone Celular</label>
             <input name="telefone" required type="text" class="form-control" id="telefone">
         </div>
        ...
        <div class="form-group col-md-5">
            ...
            <input name="repita_senha" type="password" required class="form-control" id="repita_senha">
        </div>
        ...
        <div align="center">
            <button type="submit"  style="background-color: #FF7F50;" class="btn btn-dark btn-lg btn-block"  onclick="return validar()">Alterar</button>
        </div>
