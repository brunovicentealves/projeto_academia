            ...
            if(isset($resultado)){
                foreach ($resultado as $linhas){
                    ...
                    <tr>
                       ...
                       <td><a href="../Controller/ControllerAvaliacao.php?m=1&id=<?=$linhas['id_avaliacao']?>&acao=excluir"><img  title="Excluir Avaliacao" src="../../images/delete.png"></a>&nbsp;
                        <td> <a href="../Controller/ControllerAvaliacao.php?m=1&id=<?=$linhas['id_avaliacao']?>&acao=visualizar"><img title="Visualizar Avaliacao"src="../../images/visualizar.png"></a>&nbsp;</td>
                        <td>  <a href="../Controller/ControllerAvaliacao.php?m=1&id=<?=$linhas['id_avaliacao']?>&acao=editar"><img title="editar Avaliacao"src="../../images/editar.png"></a></td>
                       </td>
