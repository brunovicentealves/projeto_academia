...
function logarProfessor($usuario,$senha){
    ...
    $stmt = $pdo->prepare("SELECT id_professor,nome_professor,senha_professor,email_professor FROM professor WHERE email_professor=:usuario AND senha_professor=:senha LIMIT 1");
